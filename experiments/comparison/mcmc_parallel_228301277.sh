...
mkdir -p exp_1_sigma=0.5_alpha=0.025_dt=0.05/seed=3047476154/mcmc/parallel_228301277
...
parallel --memsuspend 5G -j3 --delay 5 --env XLA_FLAGS,JAX_DISABLE_JIT,TF_CPP_MIN_LOG_LEVEL,OMP_NUM_THREADS,XLA_PYTHON_CLIENT_MEM_FRACTION,JAX_PLATFORM_NAME '
  ...
  python run_mcmc.py \
    ...
    --outputpath "exp_1_sigma=0.5_alpha=0.025_dt=0.05/seed=3047476154/mcmc/parallel_228301277" \
